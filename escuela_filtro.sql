...
CREATE database escuela_filtro;
use escuela_filtro;

-- creo la tabla de departamentos
CREATE table departamento(
	id INT(10) primary key,
	nombre varchar(50) not null 
);

-- creo la tabla de profesores
...
-- creo la tabla de grados
create table grado(
	id int(10) primary key,
	nombre varchar(100) not null
);

-- creo la tabla de asignaturas
...
-- creo la tabla de cursos escolares
...
-- creo la tabla de alumnos matriculados
